...
import { ArrowLeft, Star, Heart, Share, ShoppingCart, Truck, Shield, RotateCcw } from 'lucide-react-native';
...
const equipmentData = {
  1: {
    ...
    description: 'Haltères ajustables de qualité professionnelle avec système de verrouillage rapide. Parfaits pour l\'entraînement à domicile, ils remplacent un rack complet d\'haltères traditionnels.',
    features: [
...
export default function EquipmentDetailScreen() {
  ...
  const equipment = equipmentData[id as string] || equipmentData[1];
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.titleSection}>
            ...
            <View style={styles.ratingRow}>
              <View style={styles.rating}>
                ...
                <Text style={styles.reviewsText}>({equipment.reviews} avis)</Text>
              </View>
              <View style={[styles.stockBadge, !equipment.inStock && styles.outOfStock]}>
                <Text style={[styles.stockText, !equipment.inStock && styles.outOfStockText]}>
          ...
          <View style={styles.priceSection}>
            <View style={styles.priceRow}>
              <Text style={styles.currentPrice}>{equipment.price.toFixed(2)}€</Text>
              {equipment.originalPrice > equipment.price && (
                <Text style={styles.originalPrice}>{equipment.originalPrice.toFixed(2)}€</Text>
              )}
            </View>
            <Text style={styles.savings}>
              Vous économisez {(equipment.originalPrice - equipment.price).toFixed(2)}€
            </Text>
          </View>
          ...
          <View style={styles.shippingSection}>
            <View style={styles.shippingItem}>
              ...
              <View style={styles.shippingInfo}>
                ...
                <Text style={styles.shippingText}>{equipment.shipping.estimatedDays}</Text>
              </View>
            </View>
            <View style={styles.shippingItem}>
              <Shield size={20} color="#3B82F6" />
              <View style={styles.shippingInfo}>
                <Text style={styles.shippingTitle}>Garantie {equipment.specifications.Garantie}</Text>
      ...
      <View style={styles.bottomSection}>
        <View style={styles.priceInfo}>
          ...
          <Text style={styles.totalPrice}>{(equipment.price * quantity).toFixed(2)}€</Text>
        </View>
